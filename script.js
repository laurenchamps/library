...
class Library {
  ...
  _newBook(e) {
    ...
    const book = new Book(
      undefined,
      this._titleCaseify(title),
      this._titleCaseify(author),
      pages,
      isRead
    );
    ...
    if (this._inLibrary(book))
      return alert(`${book.title} is already in your library`);
    ...
    let html = `
      <div class="card" data-id="${book.id}">
        ...
        <div class="button-group">
          <button class="toggle" aria-pressed="${
            book.isRead === true ? true : false
          }"></button>
